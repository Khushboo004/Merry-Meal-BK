...
public class MerryMealApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		try {
			...
			role_careergiver.setRole_id(AppConstants.ROLE_CAREGIVER.longValue());
			role_careergiver.setRole_name("ROLE_CAREGIVER");

			List<Role> roles = roleRepository.saveAll(Arrays.asList(role_admin, role_member, role_partner, role_rider, role_volunteer,
					role_careergiver));
